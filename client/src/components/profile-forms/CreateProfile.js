...
import {createProfile} from "../../flux/actions/profile";
const CreateProfile = ({auth : {isAuthenticated , isLoading}, createProfile , history}) => {
  ...
  const [displaySocialInputs, toggleSoialInputs] = useState(false);
  ...
  return (
    <>
      ...
      <form className="form" onSubmit={onSubmit}>
        ...
        <div className="my-2">
          <button type="button" className="btn btn-light" onClick={() => toggleSoialInputs(!displaySocialInputs)}>
